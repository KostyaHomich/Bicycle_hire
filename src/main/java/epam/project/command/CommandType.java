...
public enum CommandType {
    ...
    ,SHOW_USER_LIST,SHOW_BICYCLE_LIST,SHOW_POINT_HIRE_LIST
    ,LOGOUT,SHOW_USER_DETAILS,SHOW_BICYCLE_DETAILS,
    SHOW_POINT_HIRE_DETAILS,SHOW_ORDER_LIST,SHOW_ORDER_DETAILS;
